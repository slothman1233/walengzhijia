...
import { ResCommentReplyModelListReturnModel } from '../../../../model/comment/resComment'
 ...
 * CommentModel
 */
export const AddComment = async (options: CommentModel): Promise<bodyModel<boolean>> => await http.post<any>(`/api/comment/AddComment`, options)
 ...
 * CommentReplyModel
 */
export const AddCommentReply = async (options: CommentReplyModel): Promise<bodyModel<boolean>> => await http.post<any>(`/api/comment/AddCommentReply`, options)
 ...
 * CommentQueryModel
 */
export const GetCommentList = async (options: CommentQueryModel): Promise<bodyModel<boolean>> => await http.post<any>(`/api/comment/GetCommentList`, options)
