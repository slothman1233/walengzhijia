(function($, window) {
    let CLASS_ZOOM = $.className('zoom')
    let CLASS_ZOOM_SCROLLER = $.className('zoom-scroller')

    let SELECTOR_ZOOM = '.' + CLASS_ZOOM
    let SELECTOR_ZOOM_SCROLLER = '.' + CLASS_ZOOM_SCROLLER
    ...
    $.Zoom = function(element, options) {
        ...
        let wrapperWidth, wrapperHeight, imageIsTouched, imageIsMoved, imageCurrentX, imageCurrentY, imageMinX, imageMinY, imageMaxX, imageMaxY, imageWidth, imageHeight, imageTouchesStart = {},
            imageTouchesCurrent = {},
        ...
        zoom.onTouchMove = function(e) {
            ...
            if (!imageIsMoved) {
                ...
                imageWidth = zoom.zoomer.offsetWidth
                imageHeight = zoom.zoomer.offsetHeight
                let translate = $.parseTranslateMatrix($.getStyles(zoom.scroller, 'webkitTransform'))
        ...
        zoom.onTouchEnd = function(e) {
            ...
            let momentumDistanceX = velocityX * momentumDurationX
            let newPositionX = imageCurrentX + momentumDistanceX
            let momentumDistanceY = velocityY * momentumDurationY
            let newPositionY = imageCurrentY + momentumDistanceY
