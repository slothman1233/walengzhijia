...
import { ResCompanyHotModelListReturnModel, ResCompanyInfoModelReturnModel, ResCompanyProductAdvisoryModelListReturnModel, ResCompanyProductAdvisoryModelReturnModel, ResCompanySalerModelListReturnModel, ResCompanyInfoModelListReturnModel, ResCompanyBrandModelPagedModelReturnModel } from '../model/company/resCompany'
...
class company {
    ...
    async GetCompanyInfoById(params: ByCompanyIdModel) {
        return await http.get<ResCompanyInfoModelReturnModel>(`${config.apiPath}api/Company/GetCompanyInfoById`, { params, headers: { 'Content-Type': 'application/json' } })
    }
    ...
    async GetSalersByCompanyId(params: ByCompanyIdModel) {
        return await http.get<ResCompanySalerModelListReturnModel>(`${config.apiPath}api/Company/GetSalersByCompanyId`, { params, headers: { 'Content-Type': 'application/json' } })
    }
    ...
    async GetCompanyAdvisoryByCompanyId(params: ByCompanyIdModel) {
        return await http.get<ResCompanyProductAdvisoryModelListReturnModel>(`${config.apiPath}api/Company/GetCompanyAdvisoryByCompanyId`, { params, headers: { 'Content-Type': 'application/json' } })
    }
    ...
    async GetCompanyAdvisoryByProductId(params: ByProductId) {
        return await http.get<ResCompanyProductAdvisoryModelListReturnModel>(`${config.apiPath}api/Company/GetCompanyAdvisoryByProductId`, { params, headers: { 'Content-Type': 'application/json' } })
    }
    ...
    async GetCompanyAdvisoryById(params: ByAdvisoryId) {
        return await http.get<ResCompanyProductAdvisoryModelReturnModel>(`${config.apiPath}api/Company/GetCompanyAdvisoryById`, { params, headers: { 'Content-Type': 'application/json' } })
    }

    // 获得所有公司信息
    //@CacheInterceptor('company_AddCompanyProduct', CacheTime.Min3)
    async GetCompnays() {
        return await http.get<ResCompanyInfoModelListReturnModel>(`${config.apiPath}api/Company/GetCompnays`, { headers: { 'Content-Type': 'application/json' } })
    }
    // 获得企业品牌商模型
    //@CacheInterceptor('company_AddCompanyProduct', CacheTime.Min3)
    async GetCompanyBrand(params: CompanyBrand) {
        return await http.post<ResCompanyBrandModelPagedModelReturnModel>(`${config.apiPath}api/Company/GetCompanyBrand`, params, { headers: { 'Content-Type': 'application/json' } })
    }
